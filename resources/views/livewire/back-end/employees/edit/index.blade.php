        ...
        <form wire:submit.prevent="submit">
            <div class="card-body">
                <div class="row justify-content-center">
                    <div class="col-md-4">
                        <img class="img-fluid border mr-auto ml-auto d-block mb-2" src="
                            @if ($photo)
                                {{$photo->temporaryUrl()}}
                            @else
                                {{$current_photo ? $current_photo : Utility::getDefaultPhoto('user')}}
                            @endif
                        " style="height: 200px;">
            ...
            <div class="card-footer text-right">
                <button type="submit" class="btn btn-primary">Save <span wire:loading wire:target="submit" class="fas fa-spinner fa-spin"></span></button>
            </div>
        </form>
    </div>
</div>